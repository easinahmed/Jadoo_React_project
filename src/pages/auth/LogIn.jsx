...
export default function LogIn() {
  ...
  const { currentUser, login, googleLogin, fbLogin, githubLogin, anonymousLogin, resetPass } = useAuth()

  const [showPassword, setShowPassword] = useState(false);
  const [isSubmitting, setIsSubmitting] = useState(false);
  const [forgetPassword, setForgetPass] =useState(false)
  const handleForgetPass = () => {
    setForgetPass(!forgetPassword)
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 pt-30 via-orange-50 to-pink-50 relative overflow-hidden">
      ...
      {forgetPassword? <ForgetPass resetPass={resetPass}  handleForgetPass={handleForgetPass} /> :
      /* Main Content */
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-10 relative">
            ...
            <div onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <button onClick={handleForgetPass} className="text-sm cursor-pointer text-orange-500 hover:text-orange-600 font-medium">
                  Forgot password?
                </button>
              </div>
...
const ForgetPass = ({handleForgetPass, resetPass}) => {
  ...
  return (
    <div className="container mt-20 w-[500px] flex items-center justify-center bg-gradient-to-br ">
      <div className="bg-white shadow-xl rounded-2xl p-10 w-[500px] text-center">
        <h2 className="text-3xl font-semibold font-Volkhob text-gray-800 mb-6">
          Forgot Password?
        </h2>
        <p className="text-gray-500 font-opensans text-base mb-8">
        ...
        <input
          ...
          placeholder="Enter your email"
          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400 mb-6"
        />

        <button onClick={handleReset} className="w-full text-base font-poppins cursor-pointer bg-orange-500 hover:bg-orange-600 text-white font-semibold py-3 rounded-lg transition duration-300">
          Send Reset Link
        </button>

        <p className="text-base text-gray-500 mt-6">
          Remember your password?{" "}
          <button onClick={handleForgetPass} className="text-orange-500 cursor-pointer font-poppins hover:underline">
            Go back to Login
          </button>
        </p>
      </div>
