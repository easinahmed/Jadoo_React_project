...
const EmailSubscription = () => {
    return (
        <div className="flex relative z-[1] items-center space-x-4  p-2 rounded-lg overflow-hidden max-w-lg mx-auto my-10">
            ...
            <button
                type="submit"
                className="px-6 py-2 w-[180px] h-[68px] cursor-pointer text-white font-semibold font-opensans bg-gradient-to-r from-orange-400 to-orange-500 rounded-lg hover:from-orange-500 hover:to-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition-all duration-300 ease-in-out"
            >
                Subscribe
            </button>
        </div>
